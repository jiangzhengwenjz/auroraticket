First, you must put a Pokemon Aurora Ticket Distribution (USA) ROM (with SHA1: `94A21D133E3F1B1A2129F450A9BC753D12C13B09`) in the root directory of the repository and name it `baserom.gba`. 
...
To set up the repository:
	...
	git clone https://github.com/jiangzhengwenjz/auroraticket
	git clone https://github.com/pret/agbcc

	cd ./agbcc
	sh build.sh
	sh install.sh ../auroraticket

	cd ../auroraticket

To build **auroraticket.gba**:
